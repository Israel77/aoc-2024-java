...
public class Day16Test {
        ...
        void testSolverPart1() {
                ...
                assertEquals(21148, solver.solvePart1(input3));
        }

        @Test
        @DisplayName("Should solve the example given in part 2")
        void testSolverPart2() {
                assertEquals(45, solver.solvePart2(input1));
                assertEquals(64, solver.solvePart2(input2));
                assertEquals(149, solver.solvePart2(input3));
        }
}